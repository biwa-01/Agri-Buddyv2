...
- 「夏頼り」「夏便り」→「なつたより」（枇杷品種名）
- 「春頼り」「春便り」→「はるたより」（枇杷品種名）
- 「希望」→ 枇杷栽培文脈では「希房」（品種名）の可能性を考慮
- 「膀胱」→ 枇杷栽培文脈では「房光」（品種名）
- 品種名が検出された場合はplant_varietyフィールドに抽出すること
...
10. plant_variety — 枇杷の品種名:
   主要品種: 茂木、田中、長崎早生、なつたより、涼風、涼峰、陽玉、希房、麗月、福原早生、はるたより、大房、瑞穂、白茂木、土肥、房光、楠
   - 「茂木」は場所文脈（茂木町）ではlocation、作物文脈（茂木の実、茂木を摘果）ではplant_variety
   - 「田中」は人名ではなく作物文脈でのみplant_variety
   - 未言及はフィールド省略。推測禁止`,
...
【品種別アドバイス】
plant_varietyが判明している場合、品種特性に基づくアドバイスを含める:
- なつたより: 大玉（60g超）、果皮薄く輸送注意。5月上旬〜中旬収穫。糖度高い。
- 茂木: 主力品種。やや小粒。寒さに弱い。
- 田中: 大玉。寒さにやや強い。収穫は茂木より遅い。
- 長崎早生: 極早生。ハウス栽培主体。果肉柔らか。
- 涼風: 糖度高く酸味少ない。6月上旬出荷。
- 涼峰: 大玉狙い。収穫効率重視。
- 陽玉: 甘味と酸味のバランス型。6月上旬。
- 白茂木: 希少品種。高単価。直売向き。
- 麗月: 白枇杷。糖度14%。4月下旬ハウス栽培。
  ...
  OUTPUT_SCHEMA: `【出力JSON — status は必ず "complete"】
{
  ...
  "plant_variety": "str (optional, 枇杷品種名。未言及ならフィールド省略)",
  "new_location": "string (既知リスト外の新場所名。未検出ならフィールド省略)",
  "per_location": [
    { "location": "str", "work_log": "str", "admin_log": "str", "house_data": {...}|null, "fertilizer": "str", "pest_status": "str", "pesticide_detail": "str", "harvest_amount": "str", "material_cost": "str", "work_duration": "str", "fuel_cost": "str", "plant_status": "str", "advice": "str", "strategic_advice": "str", "plant_variety": "str" }
